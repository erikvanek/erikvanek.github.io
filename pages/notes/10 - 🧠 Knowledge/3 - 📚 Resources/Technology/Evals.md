...
- What counts as "comprehensive," "well-sourced," or even "correct" depends on context
...
- More mature agents may need larger, more difficult evals to detect smaller effects
...
- Unnecessary shared state between runs can cause correlated failures due to infrastructure flakiness

#### 5. Design graders well
- choose deterministic graders where possible, LLM graders where necessary
...
- **Do not take eval scores at face value until someone digs into the details**

#### 8. Keep evaluation suites healthy through open contribution
- An eval suite is a living artifact which needs ongoing attention and clear ownership
