...
Several frameworks emerge as practical approaches: the five principles of research ethics (respect, responsibility, inclusion, honesty, evolution), the concept of "daily ethical design" with its emphasis on tracking assumptions and seeking falsifiability, and consequence scanning as a lightweight method for anticipating intended and unintended impacts. A key insight is that ethical design requires a paradigm shift—moving ethics from a constraint to a foundational objective, ideally embedded at project kick-off through a "smaller diamond" that precedes the traditional double diamond process.
...
- What perspectives are not included in our research?
- Might participants' participation harm them somehow in their future?
- Are our research activities considerate of participant's time and needs?
- Informed consent is an ongoing process, not a single event
- Aren't we promising something we're not in charge of keeping? (e.g. a tool delivery when we're responsible "only" for the discovery)
- Are we appropriately crediting those that should be acknowledged?
...
- ethical design definition from encyclopedia.com says "design ethics concerns moral behavior and responsible choices in design practice" i.e. it is about "goodness" in terms of benefits to the individual/organization/society
...
- 4 practices that prove to be valuable to start doing:
    ...
    3. aim to be proven wrong
    4. use the power of checklists
- tracking assumptions systematically allows us to systematically observe potential flaws in our designs by not choosing the right solution
- assumptions are ideally tested and evaluated continuously
...
- should be organized at initial conception of a product, during roadmap planning and before feature creation
- it is lightweight, simple to orchestrate but difficult to master
- consists of 3 key questions:
    1. What are the intended and unintended consequences of this feature or product?
    2. What are the positive consequences we want to focus on?
    3. What are the consequences we want to mitigate?
- these questions might help to map out impact of your product/feature
